...
/**
 * This class moves the robot forward and left, for a basic autonomous score
 */
@Autonomous(preselectTeleOp = "BaseMecanumDriveUsingClass")
public class autoBaseLeaveLeft extends OpMode {
    ...
    /**
     * This is the actual movement part of autonomous, moving the robot left and slight less forward, for 0.35 seconds
     */
    @Override
    public void start() {
        super.start();

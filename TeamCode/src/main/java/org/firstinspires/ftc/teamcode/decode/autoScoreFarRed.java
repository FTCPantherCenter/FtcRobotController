...
/**
 * This is an auto program for the close starting position, shooting the balls and leaving the launch zone, for red team
 */
@Autonomous
public class autoScoreFarRed extends OpMode{
    /**
